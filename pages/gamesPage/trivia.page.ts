...
export default class triviaPage {
       ...
       async verifyGameAnswerShadowText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Answer Shadow']")
              expect(ele).toContainText("Answer Shadow")
       ...
       async clickPrizingSection() {
              await this.page.frameLocator('iframe').locator("//p[text()='Prizing']").last().click({ force: true })
       ...
       async clickAddNewPrizeBtn() {
              ...
              expect(ele).toContainText("Add New Prize")
              await ele.click({force:true})
       ...
       async verifyAddNewPrizeText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Add New Prize']")
              expect(ele).toContainText("Add New Prize")
       ...
       async verifyTitleText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Title']")
              expect(ele).toContainText("Title")
             
              

       }

       async inputPrizeTitleText() {
              const ele = this.page.frameLocator('iframe').locator("(//input[contains(@class,'MuiInputBase-input MuiOutlinedInput-input')])[1]")
              expect(ele).toBeVisible()
              await ele.fill("Demo Prize")
       ...
       async verifyAddPrizingTotalPrizeText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Total Prize']")
              expect(ele).toContainText("Total Prize")
             
              

       }

       async inputAddPrizingTotalPrize() {
              const ele = this.page.frameLocator('iframe').locator("(//input[contains(@class,'MuiInputBase-input MuiOutlinedInput-input')])[2]")
              expect(ele).toBeVisible()
              await ele.fill("20")
       ...
       async verifyAddPrizingDistributionTypeText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Distribution Type']")
              expect(ele).toContainText("Distribution Type")
             
              

       }

       async selectAddPrizingDistributionTypeManual() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Manual']")
              expect(ele).toBeVisible()
              await ele.click({force:true})
       ...
       async selectAddPrizingDistributionTypeAutomatic() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Automatic']")
              expect(ele).toBeVisible()
              await ele.click({force:true})
       ...
       async verifyConditionTypeText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Condition Type']")
              expect(ele).toContainText("Condition Type")
              

       }


       async clickConditionTypeDropDownOption() {
              const ele = this.page.frameLocator('iframe').locator("//div[@role='button']")
              expect(ele).toBeVisible()
              await ele.click({force:true})
              await this.page.waitForTimeout(2000)
       ...
       async clickConditionTypeParticipationOption() {
              const ele = this.page.frameLocator('iframe').locator("//li[@data-value='Participation']")
              expect(ele).toBeVisible()
              await ele.click({force:true})
       ...
       async clickConditionTypeMultipleGamePlayOption() {
              const ele = this.page.frameLocator('iframe').locator("//li[@data-value='Multiple Game Play']")
              // expect(ele).toBeVisible()
              await ele.click({force:true})
       ...
       async clickConditionTypePointsOption() {
              const ele = this.page.frameLocator('iframe').locator("//li[@data-value='Points']")
              // expect(ele).toBeVisible()
              await ele.click({force:true})
       ...
       async clickConditionTypeTimeOption() {
              const ele = this.page.frameLocator('iframe').locator("//li[@data-value='Time']")
              // expect(ele).toBeVisible()
              await ele.click({force:true})
              await this.page.waitForTimeout(2000)
       ...
       async verifyGreaterThanorEqualText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Greater Than or Equal']")
              expect(ele).toContainText("Greater Than or Equal")
       
              

       }
       async inputGreaterThanorEqualHour() {
              const ele = this.page.frameLocator('iframe').locator("(//input[contains(@class,'MuiInputBase-input MuiInput-input')])[1]")
              expect(ele).toBeVisible()
              await ele.fill("1")
       ...
       async inputGreaterThanorEqualMinutes() {
              const ele = this.page.frameLocator('iframe').locator("(//input[contains(@class,'MuiInputBase-input MuiInput-input')])[2]")
              expect(ele).toBeVisible()
              await ele.fill("2")
       ...
       async inputGreaterThanorEqualSeconds() {
              const ele = this.page.frameLocator('iframe').locator("(//input[contains(@class,'MuiInputBase-input MuiInput-input')])[3]")
              expect(ele).toBeVisible()
              await ele.fill("3")
       ...
       async verifySelectCouponText() {
              const ele = this.page.frameLocator('iframe').locator("//p[text()='Select Coupon']")
              expect(ele).toContainText("Select Coupon")
       ...
       async clickSelectCouponInputField() {
              const ele = this.page.frameLocator('iframe').locator("//div[@class='MuiBox-root css-zzozy7']")
              expect(ele).toBeVisible()
              await ele.click()
              await this.page.waitForTimeout(2000)
       ...
       async selectCoupon() {
              const ele = this.page.frameLocator('iframe').locator("(//div[@class='MuiBox-root css-1vl0vet'])[1]")
              expect(ele).toBeVisible()
              await ele.click()              
       ...
       async clickSelectBtn() {
              const ele = this.page.frameLocator('iframe').locator("//button[text()='Select']")
              expect(ele).toBeVisible()
              await ele.click()              
