...
export default class triviaPage {
        ...
        private triviaPageElements = {
                ...
                mobileMediaInputField: "(//div[@class='MuiBox-root css-v2612'])[1]",
                mainBoardMediaInputField: "(//div[@class='MuiBox-root css-v2612'])[2]",
                disableMediaFrame: "(//input[contains(@class,'PrivateSwitchBase-input MuiSwitch-input')])[3]"
        ...
        async clickFreeResponseRadioBtn() {
                ...
                if ((ele == true)) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.freeResponseRadioBtn).click({ button: "left", delay: 1000 })
                }
        ...
        async clickMobileMediaInputField() {
                const ele = await this.page.frameLocator('iframe').locator(this.triviaPageElements.mobileMediaInputField).isVisible()
                if (ele == true) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.mobileMediaInputField).click({ button: "left", delay: 1000 })
                }
                else throw new Error("Trivia Game Add New Question Mobile Media Input Field Is not Visible")
        }

        async clickMainBoardMediaInputField() {
                const ele = await this.page.frameLocator('iframe').locator(this.triviaPageElements.mainBoardMediaInputField).isVisible()
                if (ele == true) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.mainBoardMediaInputField).click({ button: "left", delay: 1000 })
                }
                else throw new Error("Trivia Game Add New Question MainBoard Media Input Field Is not Visible")
        }
        ...
        async inputAddQuestion() {
                ...
                if (ele == true) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.inputQuestion).fill("which one is better jpg or png?")
                }
                else throw new Error("Input Question field is not visible")
        }

        async enableMediaFrameBtn() {
                const ele = await this.page.frameLocator('iframe').locator(this.triviaPageElements.disableMediaFrame).isChecked()
                if (ele == false) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.disableMediaFrame).click({button: "left", delay:1000})
                }
                else throw new Error("Trivia Game Add New Question MainBoard Media Input Field Is not Visible")
        }
        ...
        async inputCorrectAnswer() {
                ...
                if (ele == true) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.inputCorrectAnswer).fill('Demo Data For Answer 1')
                }
        ...
        async inputSecondAcctableAnswer() {
                ...
                if (ele == true) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.inputAcceptableAnswer).fill('Demo Data For Answer 2')
                }
        ...
        async inputFirstAcctableAnswer() {
                const ele = await this.page.frameLocator('iframe').locator(this.triviaPageElements.inputAcceptableAnswer).isVisible()
                if (ele == true) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.inputAcceptableAnswer).fill('Demo Data For Answer 3')
                }
                else throw new Error("Add accectable answer input is not visible")
        }
        async clikCorrectAnswerSaveBtn() {
                ...
                if (ele == true) {
                        await this.page.frameLocator('iframe').locator(this.triviaPageElements.correctAnswerSaveBtn).click({button: "left", delay:1000})
                }
