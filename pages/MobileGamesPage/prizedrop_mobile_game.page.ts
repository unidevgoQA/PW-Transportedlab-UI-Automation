...
export default class prizeDropMobilePage {
      ...
      async selectrulespage(){
        ...
        async screenshot_matcher_fullscreen_logo(){
              try {
                  await expect.soft(this.page.frameLocator('//iframe').locator('//div[@class="MuiBox-root css-15pzqls"]')).toHaveScreenshot('fullscreen_logo_test_screenshot.png',{animations:'allow',maxDiffPixelRatio:0.01})
      ...
      async screenshot_matcher_font(){
           try {
             ...
             .toHaveScreenshot('upload_font_test_screenshot.png',{animations:'allow',maxDiffPixelRatio:0.04})
